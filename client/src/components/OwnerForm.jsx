...
const OwnerForm = () => {
  ...
  if (!isOpen) {
    return (
      <button onClick={() => setIsOpen(true)} className="btn-secondary flex items-center space-x-2">
      ...
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Leave empty to use text signature</p>
          </div>
